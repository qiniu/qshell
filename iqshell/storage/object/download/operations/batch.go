...
func (info *BatchDownloadInfo) Check() *data.CodeError {
	if info.Batch.WorkerCount < 1 || info.Batch.WorkerCount > 2000 {
		info.Batch.WorkerCount = 5
	}
	if err := info.Batch.Check(); err != nil {
		return err
	}
...
func BatchDownload(cfg *iqshell.Config, info BatchDownloadInfo) {
	...
	//
	//info.Batch.InputFile = info.KeyFile
	...
	//	SuccessExportFilePath:   info.Batch.SuccessExportFilePath,
	//	FailExportFilePath:      info.Batch.FailExportFilePath,
	//	OverwriteExportFilePath: info.Batch.OverwriteExportFilePath,
	//})
	//if err != nil {
	//	log.Error(err)
	//	return
	//}
	//
	//ds, err := newDownloadScanner(info.KeyFile, info.Batch.ItemSeparate, info.Bucket, exporter)
	//if err != nil {
	//	log.Error(err)
	//	return
	//}
	...
	//	return true
	//}
	//work.NewFlowHandler(info.Batch.Info.Info).ReadWork(func() (work work.Work, hasMore bool) {
	...
	//		apiInfo.Key, info.Batch.ItemSeparate,
	//		apiInfo.FileSize, info.Batch.ItemSeparate,
	//		apiInfo.FileHash, info.Batch.ItemSeparate,
	//		apiInfo.FileModifyTime, info.Batch.ItemSeparate,
	//		err)
	//}).Start()
	//
	//if totalFileCount == 0 {
