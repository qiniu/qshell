...
func init() {
	...
	qUpload2Cmd.Flags().IntVar(&uploadConfig.LogRotate, "log-rotate", 1, "log save max days, delete when new log file created")
	qUpload2Cmd.Flags().IntVar(&uploadConfig.LogMinFileCount, "log-min-file-count", 7, "min log file count in the log dir")
