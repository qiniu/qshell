...
var cmdDocs = map[string][]string{
	...
	"zone":          []string{"qshell zone [<Zone>]", "Switch the zone, [nb, bc, hn, na0, aws]"},
	...
	"prefop":        []string{"qshell prefop <PersistentId>", "Query the fop status"},
	...
	"batchdelete":   []string{"qshell batchdelete <Bucket> <KeyListFile>", "Batch delete files in bucket"},
	"batchchgm":     []string{"qshell batchchgm <Bucket> <KeyMimeMapFile>", "Batch chgm files in bucket"},
