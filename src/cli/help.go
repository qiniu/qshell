...
var cmdDocs = map[string][]string{
	...
	"listbucket":    []string{"qshell [-d] listbucket <Bucket> [<Prefix>] <ListBucketResultFile>", "List all the files in the bucket by prefix"},
	...
	"qupload2":      []string{"qshell [-d] qupload2 [options]", "Batch upload files to the qiniu bucket"},
	...
	"sync":          []string{"qshell [-d] sync <SrcResUrl> <Bucket> <Key> [<UpHostIp>]", "Sync big file to qiniu bucket"},
	...
	"batchprefetch": []string{"qshell [-d] batchprefetch <Bucket> <KeyListFile>", "Batch prefetch the resources in the bucket"},
