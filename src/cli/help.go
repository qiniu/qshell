...
var cmdDocs = map[string][]string{
	...
	"fput":          []string{"qshell fput <Bucket> <Key> <LocalFile> [<Overwrite>] [<MimeType>] [<UpHost>]", "Form upload a local file"},
	"rput":          []string{"qshell rput <Bucket> <Key> <LocalFile> [<Overwrite>] [<MimeType>] [<UpHost>]", "Resumable upload a local file"},
	...
	"move":          []string{"qshell move <SrcBucket> <SrcKey> <DestBucket> [<DestKey>]", "Move/Rename a file and save in bucket"},
	"copy":          []string{"qshell copy <SrcBucket> <SrcKey> <DestBucket> [<DestKey>]", "Make a copy of a file and save in bucket"},
	...
	"batchcopy":     []string{"qshell batchcopy [-force] <SrcBucket> <DestBucket> <SrcDestKeyMapFile>", "Batch copy files from bucket to bucket"},
	"batchmove":     []string{"qshell batchmove [-force] <SrcBucket> <DestBucket> <SrcDestKeyMapFile>", "Batch move files from bucket to bucket"},
	"batchrename":   []string{"qshell batchrename [-force] <Bucket> <OldNewKeyMapFile>", "Batch rename files in the bucket"},
